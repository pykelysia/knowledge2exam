...
def upgrade() -> None:
    ...
    op.create_index('idx_chunk_vector', 'chunk', ['embedding'], unique=False, postgresql_using='hnsw', postgresql_with={'dim': 1536}, postgresql_ops={'embedding': 'vector_cosine_ops'})
...
def downgrade() -> None:
    ...
    op.drop_index('idx_chunk_vector', table_name='chunk', postgresql_using='hnsw', postgresql_with={'dim': 1536}, postgresql_ops={'embedding': 'vector_cosine_ops'})
    op.drop_table('chunk')
    # ### end Alembic commands ###
